  ...
  cityMissions: [
    {
      ...
      routeSummary:
        "Read the date-night guide, compare Published on Main and Kissa Tanto, then save the offer preview for later.",
      steps: [
        {
        ...
        {
          label: "Compare Published on Main",
          itemType: "business",
          itemId: "biz-harbour-table",
          time: "90 min",
          neighborhood: "Main Street",
          note: "Shows one source-backed dinner anchor with a clear Main Street fit.",
        },
        {
          label: "Compare Kissa Tanto",
          itemType: "business",
          itemId: "biz-rainline-coffee",
          time: "20 min",
          neighborhood: "Chinatown",
          note: "Keeps the route realistic by showing a second source-backed dinner option nearby.",
        },
      ],
      reward: "Create a shareable date-night plan with two realistic dinner anchors.",
      sharePrompt:
    ...
    },
    {
      ...
      timeBox: "Half day",
      hook: "A low-friction wellness plan that connects coffee, recovery, and one clear guide.",
      routeSummary:
        "Open the rainy-day guide, review the wellness guide, then keep Botanist as an indoor dinner fallback.",
      steps: [
        {
        ...
        {
          label: "Keep Botanist as the indoor fallback",
          itemType: "business",
          itemId: "biz-botanist",
          time: "20 min",
          neighborhood: "Canada Place",
          note: "Adds one real indoor option without pretending the whole rainy-day layer is fully sourced yet.",
        },
      ],
      reward: "Create a calm-day plan that can later become a newsletter segment.",
      sharePrompt:
        "CityAtlas has a rainy-day Vancouver fallback route with one calmer guide and one indoor option. I saved it for later.",
      sponsorAngle:
        "Good for calm-day local sponsors, indoor route partners, and future wellness or hospitality tie-ins once more source-backed pages are ready.",
      featured: true,
    },
    {
      ...demoAudit,
      ...
      routeSummary:
        "Start with Miku Vancouver, inspect the market event, then turn the route into a shareable waterfront plan.",
      steps: [
        {
          label: "Start with Miku Vancouver",
          itemType: "business",
          itemId: "biz-seaside-cycle",
          time: "90 min",
          neighborhood: "Waterfront",
          note: "Tests a source-backed waterfront anchor instead of a fictional activity page.",
        },
        {
        ...
        {
          label: "Share the first-evening guide",
          itemType: "guide",
          itemId: "guide-visitor-loop",
          time: "5 min",
          neighborhood: "Vancouver",
          note: "Turns browsing into an invite-worthy visitor or host plan.",
        },
      ],
      reward: "Generate a waterfront plan that can later become an invite or host route.",
      sharePrompt:
        "I saved a CityAtlas waterfront route with dinner, a market, and a Vancouver guide. Want in?",
      sponsorAngle:
        "Strong fit for waterfront restaurants, markets, event promoters, and visitor packages.",
      featured: false,
    },
  ],
  packages: [
