...
import { RESTAURANT_DAILY_SEND_LIMIT } from "./lib/cityatlas-daily-send-limits.mjs";
...
const DEFAULT_INPUT_CSV = path.resolve(
  __dirname,
  "../output/growth/vancouver-restaurant-send-packet.csv",
);
const DEFAULT_OUTPUT_DIR = path.resolve(
  __dirname,
  "../output/growth/vancouver-restaurant-daily-send-window/current",
);
const DEFAULT_LIMIT = RESTAURANT_DAILY_SEND_LIMIT;
