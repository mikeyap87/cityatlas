      ...
      <section className="city-hero">
        <div>
          ...
          <p>
            ...
            device for now, can open the route in Maps, and can copy a route summary when you are ready.
          </p>
          ...
          <div className="planner-hero-jump-grid">
            <a className="route-status-chip" href="#planner-active-route">
              <span>Route controls</span>
            </a>
            <a className="route-status-chip" href="#planner-saved-plan">
              <span>Saved plan</span>
            </a>
            <a className="route-status-chip" href="#planner-explore-more">
              <span>Explore more</span>
            </a>
          </div>
          <div className="planner-hero-trust-row">
            <StatusPill tone="green">Local route memory</StatusPill>
            <StatusPill tone="blue">Maps handoff</StatusPill>
            <StatusPill tone="muted">No account required</StatusPill>
          </div>
        </div>
        <article className="source-panel planner-hero-summary-card">
          <p className="section-label">Use this page like a route desk</p>
          ...
          <ul className="planner-hero-checklist">
            <li>Pick the route that already fits your pace.</li>
            <li>Open Maps only when you are ready to leave.</li>
            <li>Keep the saved list short enough to reuse.</li>
          </ul>
        </article>
      </section>
      ...
      <section className="split-section planner-profile-section">
        <article className="source-panel conversion-panel">
          ...
          {activeMission ? (
              ...
              <div className="hero-active-route-row">
                <div className="hero-active-route-copy">
                  <span className="hero-route-preview-kicker">
                    {activeMissionInsight ? getMissionFitLabel(activeMissionInsight) : "Start here"}
                  </span>
                  ...
                  <p>
                    {activeMissionInsight
                      ...
                      : "Open one believable full route first, then tighten it before you add more saved stops."}
                  </p>
                  <p className="hero-active-route-summary">
                    {activeMissionStartTime && activeMissionEndTime
                      ? `${activeMissionStartTime} start, around ${activeMissionEndTime} finish`
                      : activeMission.timeBox}
                  </p>
                </div>
                <a className="button secondary" href="#planner-active-route">
                  See next stop
                </a>
              </div>
            ...
            <p>Start with one guide, save a few stops, and CityAtlas will surface the clearest route here.</p>
          )}
        </article>
        <div className="source-panel conversion-panel">
          <h2>Still choosing the kind of day?</h2>
          <p>
      ...
      {activeMission ? (
        <section className="section-block" id="planner-active-route">
          <SectionHeader
            ...
            copy="See the next stop first, keep the rest of the route visible underneath, and only open the full map when you are ready to leave."
