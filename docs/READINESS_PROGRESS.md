...
- account-side Google Maps key restriction confirmation before scaling embedded-map claims
...
The current clean CRO release lane has carried the attribution and route-planner hardening through production deploy proof. The best next batch is a tiny request-first paid test with manual review, plus a separate real City Partner checkout proof before any self-serve charging claim.
