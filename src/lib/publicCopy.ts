...
export function simplifyPublicSurfaceText(value: string) {
  return tidyCopy(
    value
      ...
      .replace(/source-backed starters/gi, "local place starters")
      ...
      .replace(/official public-source anchors/gi, "real places")
      .replace(/official public-source notes/gi, "direct site links")
      .replace(/public-source anchors/gi, "real places")
      .replace(/official public-source main stops/gi, "real places")
      .replace(/public-source main stops/gi, "real places")
      .replace(/public-source notes/gi, "direct site links")
      .replace(/official public sources/gi, "official links")
      .replace(/public sources/gi, "official links")
      .replace(/official source notes/gi, "direct site links")
      .replace(/reviewed source notes/gi, "details to confirm")
      .replace(/source notes/gi, "details to confirm")
      .replace(/visible claim boundaries/gi, "details to confirm")
      .replace(/claim boundaries/gi, "details to confirm")
...
export function simplifyGuideDisplayText(value: string) {
  return tidyCopy(
    simplifyGuideTitle(value)
      ...
      .replace(/source-backed starters/gi, "local place starters")
      .replace(/source-backed starter/gi, "local starter")
