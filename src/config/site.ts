...
export const siteConfig = {
  ...
  media: {
    ...
    doorFirstVisit: resolvePublicAssetPath("/assets/lazyweb-exact/vancouver-door-first-visit.png"),
    doorDateNight: resolvePublicAssetPath("/assets/lazyweb-exact/vancouver-door-date-night.png"),
    doorRainyDay: resolvePublicAssetPath("/assets/lazyweb-exact/vancouver-door-rainy-day.png"),
    doorWeekendPlan: resolvePublicAssetPath("/assets/lazyweb-exact/vancouver-door-weekend-plan.png"),
    doorHostingGuests: resolvePublicAssetPath("/assets/lazyweb-exact/vancouver-door-hosting-guests.png"),
    pricingHeroCard: resolvePublicAssetPath("/assets/lazyweb-exact/pricing-hero-card.png"),
    pricingExampleBusiness: resolvePublicAssetPath("/assets/vancouver-rainline-cafe-hero.jpg"),
    pricingExampleGuide: resolvePublicAssetPath("/assets/places-generated/commercial-drive-generated.jpg"),
  },
  gatedActions: [
    "Domain purchase",
