...
function buildCollectionMeta(input: {
  ...
  return {
    ...
    pageTitle: `${cityName} ${toTitleCase(label)} With Official Links | CityAtlas`,
    pageDescription: input.pageDescription,
    itemListName: `${cityName} ${label} with official links`,
...
> = {
  vancouver_date_night_starters: buildCollectionMeta({
    ...
    pageDescription:
      "Five real Vancouver date-night starting points with official links, simple planning notes, and a public way to report a mistake.",
    itemListDescription:
      "A short CityAtlas list of real Vancouver date-night places with official links and simple planning notes.",
  }),
  vancouver_rainy_day_starters: buildCollectionMeta({
    path: "/vancouver/rainy-day-starters",
    shortLabel: "Rainy day starting points",
    pageDescription:
      "Five real Vancouver rainy-day starting points with official links, simple planning notes, and a public way to report a mistake.",
    itemListDescription:
      "A short CityAtlas list of real Vancouver rainy-day places with official links and simple planning notes.",
  }),
  vancouver_first_evening_starters: buildCollectionMeta({
    ...
    pageDescription:
      "Five real Vancouver first-evening starting points with official links, simple planning notes, and a public way to report a mistake.",
    itemListDescription:
      "A short CityAtlas list of real Vancouver first-evening places with official links and simple planning notes.",
  }),
  vancouver_first_time_visitor_starters: buildCollectionMeta({
    ...
    pageDescription:
      "Five real Vancouver first-time visitor starting areas with official links, simple planning notes, and a public way to report a mistake.",
    itemListDescription:
      "A short CityAtlas list of real Vancouver first-visit areas with official links and simple planning notes.",
  }),
  toronto_first_time_visitor_starters: buildCollectionMeta({
    path: "/toronto/first-time-visitor-starters",
    shortLabel: "First-time visitor starting points",
    pageDescription:
      "Five real Toronto first-time visitor starting areas with official links, simple planning notes, and a public way to report a mistake.",
    itemListDescription:
      "A short CityAtlas list of real Toronto first-visit areas with official links and simple planning notes.",
    cityName: "Toronto",
    regionName: "Ontario",
  ...
  toronto_weekend_route_starters: buildCollectionMeta({
    ...
    pageDescription:
      "Five real Toronto weekend starting points with official links, simple planning notes, and a public way to report a mistake.",
    itemListDescription:
      "A short CityAtlas list of real Toronto weekend places with official links and simple planning notes.",
    cityName: "Toronto",
    regionName: "Ontario",
    guideHubPath: "/toronto/guides",
    guideHubLabel: "Toronto Guides",
  ...
  vancouver_garden_day_starters: buildCollectionMeta({
    ...
    pageDescription:
      "Five real Vancouver garden-day starting points with official links, simple planning notes, and a public way to report a mistake.",
    itemListDescription:
      "A short CityAtlas list of real Vancouver garden and conservatory places with official links and simple planning notes.",
  }),
  vancouver_kitsilano_scenic_starters: buildCollectionMeta({
    ...
    pageDescription:
      "Five real Vancouver west-side scenic starting points with official links, simple planning notes, and a public way to report a mistake.",
    itemListDescription:
      "A short CityAtlas list of real Vancouver west-side scenic places with official links and simple planning notes.",
  }),
  vancouver_west_side_daytime_starters: buildCollectionMeta({
    ...
    pageDescription:
      "Five real Vancouver west-side daytime starting points with official links, simple planning notes, and a public way to report a mistake.",
    itemListDescription:
      "A short CityAtlas list of real Vancouver west-side daytime places with official links and simple planning notes.",
  }),
  vancouver_false_creek_culture_starters: buildCollectionMeta({
    ...
    pageDescription:
      "Five real Vancouver False Creek culture starting points with official links, simple planning notes, and a public way to report a mistake.",
    itemListDescription:
      "A short CityAtlas list of real Vancouver False Creek culture places with official links and simple planning notes.",
  }),
  vancouver_ubc_discovery_starters: buildCollectionMeta({
    ...
    pageDescription:
      "Five real Vancouver UBC discovery starting points with official links, simple planning notes, and a public way to report a mistake.",
    itemListDescription:
      "A short CityAtlas list of real Vancouver UBC-side places with official links and simple planning notes.",
  }),
  vancouver_returning_visitor_starters: buildCollectionMeta({
    ...
    pageDescription:
      "Five real Vancouver returning-visitor starting points with official links, simple planning notes, and a public way to report a mistake.",
    itemListDescription:
      "A short CityAtlas list of real Vancouver second-look places with official links and simple planning notes.",
  }),
  vancouver_out_of_town_guest_starters: buildCollectionMeta({
    ...
    pageDescription:
      "Five real Vancouver guest-hosting starting points with official links, simple planning notes, and a public way to report a mistake.",
    itemListDescription:
      "A short CityAtlas list of real Vancouver guest-friendly places with official links and simple planning notes.",
  }),
  vancouver_weekend_route_starters: buildCollectionMeta({
    ...
    pageDescription:
      "Five real Vancouver weekend-route starting points with official links, simple planning notes, and a public way to report a mistake.",
    itemListDescription:
      "A short CityAtlas list of real Vancouver weekend places with official links and simple planning notes.",
  }),
  vancouver_sunday_starters: buildCollectionMeta({
    path: "/vancouver/sunday-starters",
    shortLabel: "Sunday starting points",
    pageDescription:
      "Five real Vancouver Sunday starting points with official links, simple planning notes, and a public way to report a mistake.",
    itemListDescription:
      "A short CityAtlas list of real Vancouver Sunday places with official links and simple planning notes.",
  }),
  vancouver_wellness_reset_starters: buildCollectionMeta({
    ...
    pageDescription:
      "Five real Vancouver wellness-reset starting points with official links, simple planning notes, and a public way to report a mistake.",
    itemListDescription:
      "A short CityAtlas list of real Vancouver reset places with official links and simple planning notes.",
  }),
};
