...
export const seedData: CityAtlasData = {
  sources: [
    {
      ...
      verified: false,
      notes:
        "Used to show page structure only. Replace with supported, source-backed records before any real business page is treated as public fact.",
      updatedAt: now,
    },
    {
  ...
  businesses: [
    {
      ...
      subcategories: ["Date Night", "Tasting Menu", "Waterfront"],
      neighborhood: "Gastown",
      city: "Vancouver",
      address: "Fictional address, Gastown",
      phone: "(604) 555-0194",
      website: "https://example.com/harbour-table",
      instagram: "@harbourtable.demo",
      bookingUrl: "https://example.com/harbour-table/book",
    ...
    },
    {
      ...
      name: "Rainline Coffee",
      slug: "rainline-coffee",
      category: "Cafes",
      subcategories: ["Work-Friendly", "Coffee", "Local Favorite"],
      neighborhood: "Mount Pleasant",
      city: "Vancouver",
      address: "Fictional address, Mount Pleasant",
      phone: "(604) 555-0141",
      website: "https://example.com/rainline-coffee",
      instagram: "@rainline.demo",
      bookingUrl: "",
      heroImage: "/visual_references/01_homepage_public_site.png",
      gallery: [
        "/visual_references/01_homepage_public_site.png",
        "/assets/vancouver-market-hero.png",
      ],
      shortDescription:
    ...
    },
    {
      ...
      name: "North Shore Recovery",
      slug: "north-shore-recovery",
      category: "Wellness",
      subcategories: ["Massage", "Recovery", "Mobility"],
      neighborhood: "Yaletown",
      city: "Vancouver",
      address: "Fictional address, Yaletown",
      phone: "(604) 555-0177",
      website: "https://example.com/north-shore-recovery",
      instagram: "@northshore.demo",
      bookingUrl: "https://example.com/north-shore-recovery/book",
      heroImage: "/visual_references/03_ai_dashboards_owner_creator_mobile.png",
      gallery: [
        "/visual_references/03_ai_dashboards_owner_creator_mobile.png",
        "/assets/vancouver-market-hero.png",
      ],
      shortDescription:
    ...
    },
    {
      ...
      name: "Seaside Cycle House",
      slug: "seaside-cycle-house",
      category: "Activities",
      subcategories: ["Outdoors", "Rentals", "Scenic Routes"],
      neighborhood: "Kitsilano",
      city: "Vancouver",
      address: "Fictional address, Kitsilano",
      phone: "(604) 555-0188",
      website: "https://example.com/seaside-cycle",
      instagram: "@seasidecycle.demo",
      bookingUrl: "https://example.com/seaside-cycle/book",
      heroImage: "/assets/vancouver-market-hero.png",
  ...
  guides: [
    ...
    },
    {
      ...
      ctaPath: "/planner",
      relatedBusinessIds: ["biz-rainline-coffee", "biz-harbour-table"],
      relatedEventIds: [],
      sponsored: false,
    },
    {
      ...
      image: "/visual_references/03_ai_dashboards_owner_creator_mobile.png",
      readMinutes: 7,
      lastReviewed: "June 14, 2026",
      ...
      ctaPath: "/vancouver/missions",
      relatedBusinessIds: ["biz-north-shore-recovery"],
    ...
    },
    {
      ...
      image: "/visual_references/01_homepage_public_site.png",
      readMinutes: 6,
      lastReviewed: "June 14, 2026",
      ...
      ctaPath: "/vancouver",
      relatedBusinessIds: ["biz-rainline-coffee"],
      relatedEventIds: [],
      sponsored: false,
    },
    {
  ...
  cityMissions: [
    {
      ...
      theme: "Date night",
      audience: "Couples and visitors who want one confident plan",
      timeBox: "2 hours",
      hook: "A compact evening route that starts with a guide, moves into dinner, and ends with a saveable share moment.",
      routeSummary:
        "Read the date-night guide, check Harbour Table, then save the dessert offer as a future partner proof moment.",
      steps: [
        {
        ...
        {
          label: "Visit Harbour Table",
          itemType: "business",
          itemId: "biz-harbour-table",
          time: "90 min",
          neighborhood: "Gastown",
          note: "Models the premium partner page and date-night placement.",
        },
        {
          label: "Save the dessert feature",
          itemType: "business",
          itemId: "biz-harbour-table",
          time: "5 min",
          neighborhood: "Gastown",
          note: "Demonstrates how offers can become measurable intent before redemption is live.",
        },
      ],
      reward: "Create a shareable date-night plan and a business demand signal.",
      sharePrompt:
        "I found a two-hour Vancouver date-night loop on CityAtlas. Want to test this route with me?",
      sponsorAngle:
        "Great fit for restaurants, cocktail bars, desserts, rideshare, flowers, or creator-hosted date-night campaigns.",
      featured: true,
    },
    {
      ...demoAudit,
      ...
      theme: "Wellness",
      audience: "Locals who want a calm plan without decision fatigue",
      timeBox: "Half day",
      hook: "A low-friction wellness plan that connects coffee, recovery, and a reviewed guide.",
      routeSummary:
        "Start at Rainline Coffee, review the wellness guide, then inspect North Shore Recovery as a future partner page.",
      steps: [
        {
          label: "Start at Rainline Coffee",
          itemType: "business",
          itemId: "biz-rainline-coffee",
          time: "45 min",
          neighborhood: "Mount Pleasant",
          note: "Everyday local discovery with a light save loop.",
        },
        {
          label: "Read the wellness guide",
          itemType: "guide",
          itemId: "guide-wellness",
          time: "7 min",
          neighborhood: "Vancouver",
          note: "Shows how category guides can collect partner demand.",
        },
        {
          label: "Review North Shore Recovery",
          itemType: "business",
          itemId: "biz-north-shore-recovery",
          time: "60 min",
          neighborhood: "Yaletown",
          note: "Higher-value service category with stricter claim review.",
        },
      ],
      reward: "Create a calm-day plan that can later become a newsletter segment.",
      sharePrompt:
        "CityAtlas has a rainy-day Vancouver reset route with coffee and recovery ideas. I saved it for later.",
      sponsorAngle:
        "Good for cafes, wellness studios, mobility clinics, saunas, and calm-weekend local sponsors.",
      featured: true,
    },
    {
      ...demoAudit,
      id: "mission-weekend-waterfront",
      title: "Weekend Waterfront Sprint",
      slug: "weekend-waterfront-sprint",
      theme: "Outdoors",
      audience: "Visitors and locals planning a social weekend route",
      timeBox: "3 hours",
      hook: "A simple activity-first route that turns outdoor discovery into a shareable invite.",
      routeSummary:
        "Save Seaside Cycle House, inspect the market event, then turn the route into a group invite.",
      steps: [
        {
          label: "Start with Seaside Cycle House",
          itemType: "business",
          itemId: "biz-seaside-cycle",
          time: "90 min",
          neighborhood: "Kitsilano",
          note: "Tests activity/rental partner demand.",
        },
        {
          label: "Check the market night",
          itemType: "event",
          itemId: "event-market-night",
          time: "60 min",
          neighborhood: "Mount Pleasant",
          note: "Connects event discovery to a weekend plan.",
        },
        {
          label: "Share the route",
          itemType: "guide",
          itemId: "guide-date-night",
          time: "5 min",
          neighborhood: "Vancouver",
          note: "Turns browsing into an invite-worthy loop.",
        },
      ],
      reward: "Generate a weekend plan that can later become an invite/referral loop.",
      sharePrompt:
        "I saved a CityAtlas weekend route with cycling, a market, and a Vancouver guide. Want in?",
      sponsorAngle:
        "Strong fit for activity operators, markets, event promoters, bike rentals, and visitor packages.",
      featured: false,
    },
  ],
  packages: [
  ...
  auditLogs: [
    {
      ...
      summary:
        "Loaded fictional Vancouver seed graph. No real business facts, offers, reviews, or ratings are asserted.",
      createdAt: now,
    },
  ],
};
