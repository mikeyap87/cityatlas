...
function getPaymentStateLabel(paymentState: string) {
  if (paymentState === "disabled_until_launch_approval") {
    return "Checkout opens after a quick check";
  }
  return "Start with a quick check";
}
    ...
    <>
      <section className="pricing-hero">
        <div>
          ...
          <p>
            Start with a quick check. CityAtlas checks the fit first, then opens checkout only
      ...
      <section className="section-block">
        <SectionHeader
          label="How it works"
          title="Start with a simple check before any billing"
        ...
        <div className="guide-query-grid">
          ...
          <article className="query-card">
            ...
            <strong>Get a fit and scope check</strong>
      ...
      <section className="section-block">
        <SectionHeader
          ...
          copy="These packages show the shape of the offer. Checkout opens only after the check, scope confirmation, and clear terms."
          action={<StatusPill tone="amber">Start with a quick check</StatusPill>}
        />
      ...
      <section className="section-block">
        <SectionHeader
          ...
          copy="CityAtlas works best when a business names the real problem first: guide placement, event or offer support, trust questions, or a stronger page."
        ...
        <div className="guide-query-grid">
          ...
          <AppLink className="query-card query-card-link" to="/for-businesses/submit">
            ...
            <p>Go straight to the request form when the business already knows it wants a CityAtlas page, package, or better local visibility.</p>
          </AppLink>
        </div>
      </section>
      ...
      <section className="split-section">
        <div className="source-panel conversion-panel">
          ...
          <ul className="conversion-list">
            <li><CheckIcon /> A clear page outline with current status.</li>
            <li><CheckIcon /> Guide and neighborhood placement check.</li>
        ...
        <div className="source-panel conversion-panel">
          ...
          <ul className="conversion-list">
            ...
            <li><LockIcon /> No automated outreach until compliance is checked.</li>
            <li><LockIcon /> No health, event, or offer claims without extra checking.</li>
          </ul>
        </div>
      </section>
      ...
      <section className="section-block">
        ...
        <div className="card-grid three">
          <article className="source-panel conversion-panel">
            ...
            <p>
              CityAtlas starts with a local business request, checks whether the business is a fit
          ...
          <article className="source-panel conversion-panel">
            <h2>When should a business start a request now?</h2>
            <p>
              Start a request when the business already knows it needs better neighborhood
              visibility, guide placement, offer packaging, or a clearer city-facing story and is
              comfortable beginning with a quick check instead of instant self-serve billing.
            </p>
          </article>
          <article className="source-panel conversion-panel">
      ...
      <section className="cta-band">
        <ShieldIcon />
        <div>
          <h2>Best first step for a local business</h2>
          <p>
            Use this page for early partner conversations first. Open checkout only after the fit
            is clear and demand is proven.
          </p>
        </div>
        <AppLink className="button primary" to="/for-businesses/submit">
      ...
      <section className="split-section">
        <div className="source-panel">
          ...
          <p>
            Requests stay private to this form and can be checked for fit, facts, and next steps
            before anything is published.
          </p>
        </div>
        <div className="source-panel">
          <LockIcon />
          <h2>What still waits for approval</h2>
          <p>
            No checkout, no invoices, no automated email, no provider imports, and no public
            publication of real business claims before a check.
          </p>
        </div>
      </section>
    </>
