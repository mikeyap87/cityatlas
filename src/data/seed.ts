  ...
  cityMissions: [
    {
      ...
      hook: "A compact Chinatown-to-Gastown evening with one dinner anchor and one lighter finish.",
      routeSummary:
        "Open the date-night guide before leaving, settle into Kissa Tanto for dinner, then walk into Gastown for one lighter second stop at L'Abattoir.",
      steps: [
        {
        ...
        {
          label: "Dinner at Kissa Tanto",
          itemType: "business",
          itemId: "biz-rainline-coffee",
          time: "90 min",
          neighborhood: "Chinatown",
          note: "Use this as the main anchor when you want the reservation to carry the night.",
          durationMinutes: 90,
          bestAt: "Aim for 6:30 PM to 7:30 PM",
        },
        {
          label: "Second stop at L'Abattoir",
          itemType: "business",
          itemId: "biz-north-shore-recovery",
          time: "45 min",
          neighborhood: "Gastown",
          note: "Finish with one lighter second stop instead of another full reset across the city.",
          durationMinutes: 45,
          bestAt: "Best after dinner",
          travelMinutesByMode: {
            walk: 14,
            transit: 10,
            drive: 8,
      ...
      idealFor: [
        "Date nights that stay compact",
        "Visitor dinners that feel confident",
        "Chinatown-to-Gastown evenings",
      ],
      reward: "Create a shareable date-night plan with one dinner anchor and one easy second stop.",
      sharePrompt:
        "I found a compact Vancouver date-night route on CityAtlas. Want to try it with me this week?",
      sponsorAngle:
