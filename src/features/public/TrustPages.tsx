...
function SourceBackedReferenceCard({
  ...
  const visibleTags = Array.from(
    new Set([reference.neighborhood, ...reference.bestFor.slice(0, 1)].filter(Boolean)),
  );
  ...
  return (
    <article className="source-panel source-reference-card">
      ...
      <div className="source-reference-body">
        ...
        <div className="hero-actions source-reference-primary-action">
          <a
        ...
        <details className="disclosure-card source-reference-support">
          <summary className="disclosure-summary">
            <div className="source-reference-support-copy">
              <strong>Why CityAtlas included this place</strong>
              <p>
                Checked against {reference.sourceOwner} on {reference.sourceCheckedAt}.
              </p>
            </div>
            <span className="disclosure-tag">Optional</span>
          </summary>
          <div className="disclosure-body source-reference-support-body">
            ...
            <div className="source-reference-support-links">
    ...
    <>
      <section className="city-hero official-source-hero">
        <div>
          ...
          <p>
            Open one real place first. Use the official site for the last details. Only open the
            fuller guide if this short list still is not enough.
          </p>
          <div className="official-source-hero-tags tag-cloud">
            <span>Official site links</span>
            <span>Why it fits</span>
            <span>Report a mistake</span>
          </div>
          <div className="hero-actions">
            <a className="button primary" href="#local-places-first">
              Open one place first
            </a>
          ...
          <p className="planner-hero-note">
            {starters.length} places with official links are on this page now.
          </p>
        </div>
      </section>

      <section className="section-block" id="local-places-first">
        <SectionHeader
          label="Local places"
          title="Open one real place first"
          copy="Pick one place that feels right, open the official site, and stop there unless you still need more help."
        />
        ...
        <details className="planner-detail-group pricing-package-disclosure">
          <summary className="planner-detail-summary">
            <div>
              ...
              <strong>Need the guide, the simple rules, or a correction link?</strong>
            </div>
          ...
          <div className="planner-detail-body">
            <p className="planner-detail-copy">
              Open this only if one place is not enough yet or you need to check how CityAtlas
              handles corrections and trust rules.
            </p>
            <div className="split-section">
              ...
              <div className="source-panel conversion-panel">
                ...
                <p>
                  Open the fuller guide when you want more pace, neighborhood, or planning context
                  after one strong place already looks right.
                </p>
                {matchingGuide ? (
            ...
            <article className="source-panel conversion-panel">
              ...
              <p>
                Use the editorial standards page to report outdated details, request a correction,
                or ask for a page change.
              </p>
