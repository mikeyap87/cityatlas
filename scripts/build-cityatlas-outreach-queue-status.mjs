  ...
  const status = {
    ...
    bestNextMove:
      ownerReviewReadyRows > 0
        ? "Let the next daily automation send only the manifest rows, then reply quickly to any interested businesses with the partner-preview link and hosted-experience ask."
