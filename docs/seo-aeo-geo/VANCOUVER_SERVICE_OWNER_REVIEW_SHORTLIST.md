...
- Total Vancouver service prospects considered in this run: 452
- Imported official service review rows folded in from Outscraper: 17
- Service seed rows regenerated: 461
- Email-ready service rows promoted into owner-review-ready: 0
- Rows currently tagged as Greater Vancouver rather than Vancouver-only: 347
- Contact-path or hold rows kept review-only: 389
- Already-sent service rows preserved from the live ledger: 72
- Current shortlist size: 0
