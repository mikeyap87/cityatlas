...
function buildBody(prospect, candidate) {
  ...
  return [
    ...
    "",
    "I run CityAtlas, a Vancouver discovery site built around local routes, neighborhood guides, and trusted local businesses instead of flat listings.",
    "",
    ...
    "",
    "If the fit feels good, I would love to line up a hosted visit, service preview, or founder walkthrough so I can build the feature with accurate detail.",
    "",
