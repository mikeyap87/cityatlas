...
const footerGroups = [
  {
    ...
    note: "Best first guides, local places, ready-made routes, and the planner.",
    links: [
      ...
      { to: "/vancouver/missions", label: "Ready-made routes" },
  ...
  },
  {
      ...
      links: [
        ...
        { to: "/for-businesses/status", label: "Request status" },
...
function getRouteLibraryNavPath(path: string) {
  return path.startsWith("/toronto/") ? "/toronto/missions" : "/vancouver/missions";
}

const mobileCompassLinks = [
  {
    id: "tonight",
    className: "compass-link compass-link-top",
  ...
  {
    id: "right-now",
    className: "compass-link compass-link-left",
  ...
  {
    id: "outdoors",
    className: "compass-link compass-link-right",
  ...
  {
    id: "rainy-day",
    className: "compass-link compass-link-bottom",
...
export function PublicLayout({ children, path }: LayoutProps) {
  ...
  const routeLibraryNavPath = getRouteLibraryNavPath(path);
    ...
    <div className="app-shell">
      <header className="site-header">
        ...
        >
          <AppLink
            to="/vancouver"
            className={`${navClass(path, "/vancouver")} nav-desktop-link`}
          ...
          <AppLink
            to="/about"
            className={`${navClass(path, "/about")} nav-desktop-link`}
            onClick={closeMobileNav}
          >
            About
          </AppLink>
          <AppLink
            to={guidesNavPath}
            className={`${navClass(path, guidesNavPath)} nav-desktop-link`}
            onClick={closeMobileNav}
          >
            Guides
          </AppLink>
          <AppLink
            to="/vancouver/date-night-starters"
            className={`${navClass(path, "/vancouver/date-night-starters")} nav-desktop-link`}
            onClick={closeMobileNav}
          >
            Local places
          </AppLink>
          <AppLink
            to={routeLibraryNavPath}
            className={`${navClass(path, routeLibraryNavPath)} nav-desktop-link`}
            onClick={closeMobileNav}
          >
            Routes
          </AppLink>
          <AppLink
            to="/planner"
            className={`${navClass(path, "/planner")} nav-desktop-link`}
            onClick={closeMobileNav}
          >
            Planner
          </AppLink>
          <AppLink
            ...
            className={`${navClass(path, "/for-businesses")} nav-desktop-link`}
            onClick={closeMobileNav}
          >
            For businesses
          </AppLink>

          <div className="mobile-compass-menu">
            <div className="mobile-compass-map">
              <div className="mobile-compass-wheel" aria-label="Choose a quick Vancouver direction">
                {mobileCompassLinks.map((item) => {
                ...
                <AppLink className="compass-search" onClick={closeMobileNav} to="/vancouver">
                  <SearchIcon />
                  <span>Search</span>
                </AppLink>
              </div>
              <span className="mobile-compass-more-label">More</span>
            </div>
            <div className="mobile-menu-more-grid" aria-label="More CityAtlas links">
              <AppLink to="/vancouver/guides" onClick={closeMobileNav}>
                Guides
              </AppLink>
              <AppLink to="/vancouver/date-night-starters" onClick={closeMobileNav}>
                Local places
              </AppLink>
              <AppLink to={routeLibraryNavPath} onClick={closeMobileNav}>
                Ready-made routes
              </AppLink>
              <AppLink to="/planner" onClick={closeMobileNav}>
                Planner
              </AppLink>
              <AppLink to="/for-businesses/pricing" onClick={closeMobileNav}>
                For businesses
              </AppLink>
              <AppLink to="/about" onClick={closeMobileNav}>
                About
              </AppLink>
            </div>
          </div>
